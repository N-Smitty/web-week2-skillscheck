...
// Create an object called 'me' that has the following keys: firstName, state, age, and greeter. The value of the firstName 
// key should be your name as a string. The value of the property state should be your current state or providence of residence as a string.
//The value of age should be your age as a number. greeter should be a method that returns the string 'Hello! My name is NAMEVALUE and I live
// in STATEVALUE' with the corresponding values. 
...
// Using a for loop, loop over the passed in array IN REVERSE (this means your counter should decrement), and then add each item to the 'reversed' array 
// variable you created. Finally, return the 'reversed' array variable. 
...
// Code Here
let doubled = myNumbers.map(numbers => numbers *2)
...
// Code Here
let filtered = myNumbers.filter( numbers => numbers > 100)
...
// Code Here
let total = myNumbers.reduce((acc, numbers) => acc += numbers,0)
//////////////////PROBLEM 17////////////////////
